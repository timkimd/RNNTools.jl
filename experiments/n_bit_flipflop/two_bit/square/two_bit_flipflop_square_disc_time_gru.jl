...
@save "two_stats_varying_amp_"*string(idx)*"_gru.bson" losses_gru val_losses_gru grad_norms_gru time_gru lps_gru
@save "two_params_varying_amp_"*string(idx)*"_gru.bson" θ_opt_gru θ_init_gru