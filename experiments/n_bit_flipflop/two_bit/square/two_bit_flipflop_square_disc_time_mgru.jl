...
@save "two_stats_varying_amp_"*string(idx)*"_mgru.bson" losses_mgru val_losses_mgru grad_norms_mgru time_mgru lps_mgru
@save "two_params_varying_amp_"*string(idx)*"_mgru.bson" θ_opt_mgru θ_init_mgru