...
@save "rnn_stats_varying_amp_gru_100_"*string(idx)*".bson" losses_gru val_losses_gru grad_norms_gru time_gru lps_gru
@save "rnn_params_varying_amp_gru_100_"*string(idx)*".bson" θ_opt_gru θ_init_gru h0