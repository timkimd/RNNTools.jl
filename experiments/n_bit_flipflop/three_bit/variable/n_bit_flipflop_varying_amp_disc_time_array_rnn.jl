...
@save "rnn_stats_varying_amp_rnn_100_"*string(idx)*".bson" losses_rnn val_losses_rnn grad_norms_rnn time_rnn lps_rnn
@save "rnn_params_varying_amp_rnn_100_"*string(idx)*".bson" θ_opt_rnn θ_init_rnn h0