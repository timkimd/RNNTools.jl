...
args = HPs(
    ...
    solver = "Euler()",
    dynamics_nonlinearity = "identity",
...
@save "rnn_stats_varying_amp_gnode_6_"*string(idx)*".bson" losses_gnode val_losses_gnode grad_norms_gnode time_gnode lps_gnode
@save "rnn_params_varying_amp_gnode_6_"*string(idx)*".bson" θ_opt_gnode θ_init_gnode h0