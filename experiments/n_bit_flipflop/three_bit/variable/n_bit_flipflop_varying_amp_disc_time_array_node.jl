...
@save "rnn_stats_varying_amp_node_100_"*string(idx)*".bson" losses_node val_losses_node grad_norms_node time_node lps_node
@save "rnn_params_varying_amp_node_100_"*string(idx)*".bson" θ_opt_node θ_init_node h0